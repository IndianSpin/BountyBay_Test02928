...
honest N cells + the two known REDs recorded (BB-254). **Standing
down** — next QA duty: BB-256 gate once W2's golden reference exists,
plus the re-walk after BB-257 wiring.
