...
| W1-03 | worker-1 | API timeline wiring (D-11) — STARTED | w1-dd-mechanics | serve IN-2 timeline via `apps/api/src/match-routes.ts` | W1-01 ACCEPTed (done), W1-02 report written (done), IN-2 ACCEPTed (done) | Timeline reachable from the review route; tests per AGENTS.md rule |
